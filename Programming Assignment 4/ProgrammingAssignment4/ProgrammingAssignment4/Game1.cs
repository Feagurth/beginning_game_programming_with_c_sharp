...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            gameBoard = new Board(Content, graphics.PreferredBackBufferWidth / 2, graphics.PreferredBackBufferHeight / 2);

            // STUDENTS: CREATE QUIT BUTTON HERE, CENTERED HORIZONTALLY AND WITH A REASONABLE SPACE ABOVE THE BOTTOM OF THE WINDOW
            quitButton = new QuitButton(Content, graphics.PreferredBackBufferWidth / 2,  9 * (graphics.PreferredBackBufferHeight / 10), GameState.Quit);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (gameState == GameState.Play)
            {
                if (whoseTurn == PlayerType.Human)
                {
                    ...
                    bool play = gameBoard.TakePlayerTurn(mouse);
            ...
            if (gameState == GameState.Play && gameBoard.GameOver())
            {
